    		...
    		<div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="post" action="{{route('doctor.update',$doctor->id)}}">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control{{ $errors->has('name') ? ' form-control-danger' : '' }}" name="name" value="{{ $doctor->doctor_name }}">
                              @if ($errors->has('name'))
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control{{ $errors->has('number') ? ' form-control-danger' : '' }}" name="number" value="{{ $doctor->doctor_number }}">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control{{ $errors->has('clinic_name') ? ' form-control-danger' : '' }}" name="clinic_name" value="{{ $doctor->doctor_clinic }}">
